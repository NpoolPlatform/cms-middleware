...
func (mq *MediaQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (mq *MediaQuery) FirstIDX(ctx context.Context) uint32 {
...
func (mq *MediaQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (mq *MediaQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (mq *MediaQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (mq *MediaQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := mq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (mq *MediaQuery) prepareQuery(ctx context.Context) error {
	...
	if media.Policy == nil {
		return errors.New("ent: uninitialized media.Policy (forgotten import ent/runtime?)")
	}
	if err := media.Policy.EvalQuery(ctx, mq); err != nil {
		return err
	}
	return nil
}
...
func (mq *MediaQuery) ForUpdate(opts ...sql.LockOption) *MediaQuery {
...
func (mq *MediaQuery) ForShare(opts ...sql.LockOption) *MediaQuery {
	if mq.driver.Dialect() == dialect.Postgres {
		mq.Unique(false)
	}
	mq.modifiers = append(mq.modifiers, func(s *sql.Selector) {
