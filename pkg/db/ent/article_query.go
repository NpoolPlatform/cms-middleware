...
func (aq *ArticleQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (aq *ArticleQuery) FirstIDX(ctx context.Context) uint32 {
...
func (aq *ArticleQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (aq *ArticleQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (aq *ArticleQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (aq *ArticleQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *ArticleQuery) prepareQuery(ctx context.Context) error {
	...
	if article.Policy == nil {
		return errors.New("ent: uninitialized article.Policy (forgotten import ent/runtime?)")
	}
	if err := article.Policy.EvalQuery(ctx, aq); err != nil {
		return err
	}
	return nil
}
