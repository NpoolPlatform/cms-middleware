...
// CategoryLangMutation represents an operation that mutates the CategoryLang nodes in the graph.
type CategoryLangMutation struct {
	config
	op            Op
	typ           string
	id            *uint32
	...
	oldValue      func(context.Context) (*CategoryLang, error)
	predicates    []predicate.CategoryLang
}

var _ ent.Mutation = (*CategoryLangMutation)(nil)

// categorylangOption allows management of the mutation configuration using functional options.
type categorylangOption func(*CategoryLangMutation)

// newCategoryLangMutation creates new mutation for the CategoryLang entity.
func newCategoryLangMutation(c config, op Op, opts ...categorylangOption) *CategoryLangMutation {
	m := &CategoryLangMutation{
		config:        c,
		op:            op,
		typ:           TypeCategoryLang,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withCategoryLangID sets the ID field of the mutation.
func withCategoryLangID(id uint32) categorylangOption {
	return func(m *CategoryLangMutation) {
		var (
			err   error
			once  sync.Once
			value *CategoryLang
		)
		m.oldValue = func(ctx context.Context) (*CategoryLang, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().CategoryLang.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withCategoryLang sets the old CategoryLang of the mutation.
func withCategoryLang(node *CategoryLang) categorylangOption {
	return func(m *CategoryLangMutation) {
		m.oldValue = func(context.Context) (*CategoryLang, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m CategoryLangMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m CategoryLangMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of CategoryLang entities.
func (m *CategoryLangMutation) SetID(id uint32) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *CategoryLangMutation) ID() (id uint32, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *CategoryLangMutation) IDs(ctx context.Context) ([]uint32, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().CategoryLang.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *CategoryLangMutation) SetCreatedAt(u uint32) {
	m.created_at = &u
	m.addcreated_at = nil
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *CategoryLangMutation) CreatedAt() (r uint32, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the CategoryLang entity.
// If the CategoryLang object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CategoryLangMutation) OldCreatedAt(ctx context.Context) (v uint32, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddCreatedAt adds u to the "created_at" field.
func (m *CategoryLangMutation) AddCreatedAt(u int32) {
	if m.addcreated_at != nil {
		*m.addcreated_at += u
	} else {
		m.addcreated_at = &u
...
// AddedCreatedAt returns the value that was added to the "created_at" field in this mutation.
func (m *CategoryLangMutation) AddedCreatedAt() (r int32, exists bool) {
	v := m.addcreated_at
	if v == nil {
		return
	}
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *CategoryLangMutation) ResetCreatedAt() {
	m.created_at = nil
	m.addcreated_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *CategoryLangMutation) SetUpdatedAt(u uint32) {
	m.updated_at = &u
	m.addupdated_at = nil
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *CategoryLangMutation) UpdatedAt() (r uint32, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the CategoryLang entity.
// If the CategoryLang object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CategoryLangMutation) OldUpdatedAt(ctx context.Context) (v uint32, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddUpdatedAt adds u to the "updated_at" field.
func (m *CategoryLangMutation) AddUpdatedAt(u int32) {
	if m.addupdated_at != nil {
		*m.addupdated_at += u
	} else {
		m.addupdated_at = &u
...
// AddedUpdatedAt returns the value that was added to the "updated_at" field in this mutation.
func (m *CategoryLangMutation) AddedUpdatedAt() (r int32, exists bool) {
	v := m.addupdated_at
	if v == nil {
		return
	}
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *CategoryLangMutation) ResetUpdatedAt() {
	m.updated_at = nil
	m.addupdated_at = nil
}

// SetDeletedAt sets the "deleted_at" field.
func (m *CategoryLangMutation) SetDeletedAt(u uint32) {
	m.deleted_at = &u
	m.adddeleted_at = nil
}

// DeletedAt returns the value of the "deleted_at" field in the mutation.
func (m *CategoryLangMutation) DeletedAt() (r uint32, exists bool) {
	v := m.deleted_at
	if v == nil {
		return
	}
...
// OldDeletedAt returns the old "deleted_at" field's value of the CategoryLang entity.
// If the CategoryLang object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CategoryLangMutation) OldDeletedAt(ctx context.Context) (v uint32, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDeletedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddDeletedAt adds u to the "deleted_at" field.
func (m *CategoryLangMutation) AddDeletedAt(u int32) {
	if m.adddeleted_at != nil {
		*m.adddeleted_at += u
	} else {
		m.adddeleted_at = &u
...
// AddedDeletedAt returns the value that was added to the "deleted_at" field in this mutation.
func (m *CategoryLangMutation) AddedDeletedAt() (r int32, exists bool) {
	v := m.adddeleted_at
	if v == nil {
		return
	}
...
// ResetDeletedAt resets all changes to the "deleted_at" field.
func (m *CategoryLangMutation) ResetDeletedAt() {
	m.deleted_at = nil
	m.adddeleted_at = nil
}

// SetEntID sets the "ent_id" field.
func (m *CategoryLangMutation) SetEntID(u uuid.UUID) {
	m.ent_id = &u
}

// EntID returns the value of the "ent_id" field in the mutation.
func (m *CategoryLangMutation) EntID() (r uuid.UUID, exists bool) {
	v := m.ent_id
	if v == nil {
		return
	}
...
// OldEntID returns the old "ent_id" field's value of the CategoryLang entity.
// If the CategoryLang object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CategoryLangMutation) OldEntID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldEntID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetEntID resets all changes to the "ent_id" field.
func (m *CategoryLangMutation) ResetEntID() {
	m.ent_id = nil
}

// SetAppID sets the "app_id" field.
func (m *CategoryLangMutation) SetAppID(u uuid.UUID) {
	m.app_id = &u
}

// AppID returns the value of the "app_id" field in the mutation.
func (m *CategoryLangMutation) AppID() (r uuid.UUID, exists bool) {
	v := m.app_id
	if v == nil {
		return
	}
...
// OldAppID returns the old "app_id" field's value of the CategoryLang entity.
// If the CategoryLang object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CategoryLangMutation) OldAppID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAppID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetAppID resets all changes to the "app_id" field.
func (m *CategoryLangMutation) ResetAppID() {
	m.app_id = nil
}

// SetLangID sets the "lang_id" field.
func (m *CategoryLangMutation) SetLangID(u uuid.UUID) {
	m.lang_id = &u
}

// LangID returns the value of the "lang_id" field in the mutation.
func (m *CategoryLangMutation) LangID() (r uuid.UUID, exists bool) {
	v := m.lang_id
	if v == nil {
		return
	}
...
// OldLangID returns the old "lang_id" field's value of the CategoryLang entity.
// If the CategoryLang object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CategoryLangMutation) OldLangID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CategoryLangMutation) ClearLangID() {
	m.lang_id = nil
	m.clearedFields[categorylang.FieldLangID] = struct{}{}
}

// LangIDCleared returns if the "lang_id" field was cleared in this mutation.
func (m *CategoryLangMutation) LangIDCleared() bool {
	_, ok := m.clearedFields[categorylang.FieldLangID]
	return ok
}

// ResetLangID resets all changes to the "lang_id" field.
func (m *CategoryLangMutation) ResetLangID() {
	m.lang_id = nil
	delete(m.clearedFields, categorylang.FieldLangID)
}

// SetCategoryID sets the "category_id" field.
func (m *CategoryLangMutation) SetCategoryID(u uuid.UUID) {
	m.category_id = &u
}

// CategoryID returns the value of the "category_id" field in the mutation.
func (m *CategoryLangMutation) CategoryID() (r uuid.UUID, exists bool) {
	v := m.category_id
	if v == nil {
		return
	}
...
// OldCategoryID returns the old "category_id" field's value of the CategoryLang entity.
// If the CategoryLang object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CategoryLangMutation) OldCategoryID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCategoryID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearCategoryID clears the value of the "category_id" field.
func (m *CategoryLangMutation) ClearCategoryID() {
	m.category_id = nil
	m.clearedFields[categorylang.FieldCategoryID] = struct{}{}
}

// CategoryIDCleared returns if the "category_id" field was cleared in this mutation.
func (m *CategoryLangMutation) CategoryIDCleared() bool {
	_, ok := m.clearedFields[categorylang.FieldCategoryID]
	return ok
}

// ResetCategoryID resets all changes to the "category_id" field.
func (m *CategoryLangMutation) ResetCategoryID() {
	m.category_id = nil
	delete(m.clearedFields, categorylang.FieldCategoryID)
}

// SetDisplay sets the "display" field.
func (m *CategoryLangMutation) SetDisplay(s string) {
	m.display = &s
}

// Display returns the value of the "display" field in the mutation.
func (m *CategoryLangMutation) Display() (r string, exists bool) {
	v := m.display
	if v == nil {
		return
	}
...
// OldDisplay returns the old "display" field's value of the CategoryLang entity.
// If the CategoryLang object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CategoryLangMutation) OldDisplay(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CategoryLangMutation) ClearDisplay() {
	m.display = nil
	m.clearedFields[categorylang.FieldDisplay] = struct{}{}
}

// DisplayCleared returns if the "display" field was cleared in this mutation.
func (m *CategoryLangMutation) DisplayCleared() bool {
	_, ok := m.clearedFields[categorylang.FieldDisplay]
	return ok
}

// ResetDisplay resets all changes to the "display" field.
func (m *CategoryLangMutation) ResetDisplay() {
	m.display = nil
	delete(m.clearedFields, categorylang.FieldDisplay)
}

// Where appends a list predicates to the CategoryLangMutation builder.
func (m *CategoryLangMutation) Where(ps ...predicate.CategoryLang) {
	m.predicates = append(m.predicates, ps...)
}

// Op returns the operation name.
func (m *CategoryLangMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (CategoryLang).
func (m *CategoryLangMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *CategoryLangMutation) Fields() []string {
	fields := make([]string, 0, 8)
	if m.created_at != nil {
		fields = append(fields, categorylang.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, categorylang.FieldUpdatedAt)
	}
	if m.deleted_at != nil {
		fields = append(fields, categorylang.FieldDeletedAt)
	}
	if m.ent_id != nil {
		fields = append(fields, categorylang.FieldEntID)
	}
	if m.app_id != nil {
		fields = append(fields, categorylang.FieldAppID)
	}
	if m.lang_id != nil {
		fields = append(fields, categorylang.FieldLangID)
	}
	if m.category_id != nil {
		fields = append(fields, categorylang.FieldCategoryID)
	}
	if m.display != nil {
		fields = append(fields, categorylang.FieldDisplay)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *CategoryLangMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *CategoryLangMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case categorylang.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case categorylang.FieldUpdatedAt:
	...
	return nil, fmt.Errorf("unknown CategoryLang field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CategoryLangMutation) SetField(name string, value ent.Value) error {
	switch name {
	case categorylang.FieldCreatedAt:
		v, ok := value.(uint32)
		if !ok {
	...
	return fmt.Errorf("unknown CategoryLang field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *CategoryLangMutation) AddedFields() []string {
	var fields []string
	if m.addcreated_at != nil {
		fields = append(fields, categorylang.FieldCreatedAt)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *CategoryLangMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case categorylang.FieldCreatedAt:
		return m.AddedCreatedAt()
	case categorylang.FieldUpdatedAt:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CategoryLangMutation) AddField(name string, value ent.Value) error {
	switch name {
	case categorylang.FieldCreatedAt:
		v, ok := value.(int32)
		if !ok {
	...
	return fmt.Errorf("unknown CategoryLang numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *CategoryLangMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(categorylang.FieldLangID) {
		fields = append(fields, categorylang.FieldLangID)
	}
	if m.FieldCleared(categorylang.FieldCategoryID) {
		fields = append(fields, categorylang.FieldCategoryID)
	}
	if m.FieldCleared(categorylang.FieldDisplay) {
		fields = append(fields, categorylang.FieldDisplay)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *CategoryLangMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *CategoryLangMutation) ClearField(name string) error {
	switch name {
	case categorylang.FieldLangID:
		m.ClearLangID()
		return nil
	...
	return fmt.Errorf("unknown CategoryLang nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *CategoryLangMutation) ResetField(name string) error {
	switch name {
	case categorylang.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *CategoryLangMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *CategoryLangMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *CategoryLangMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *CategoryLangMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *CategoryLangMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *CategoryLangMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *CategoryLangMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown CategoryLang unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *CategoryLangMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown CategoryLang edge %s", name)
}
